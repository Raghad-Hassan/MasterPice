      ...
      <div class="row text-center text-md-start align-items-start">
        ...
        <div class="col-md-4 mb-4 order-2 order-md-2 d-flex flex-column align-items-center">
          ...
          <ul class="list-unstyled text-center" style="margin-left: 120px;font-size: 16px;">
            <li class="mb-2"><a href="index.html" class="text-white text-decoration-none d-block">الصفحة الرئيسية</a></li>
            <li class="mb-2"><a href="تعرف علينا.html" class="text-white text-decoration-none d-block">تعرف علينا</a></li>
            <li class="mb-2"><a href="لماذا نساهم.html" class="text-white text-decoration-none d-block">لماذا نساهم؟</a></li>
            <li class="mb-2"><a href="عرض الفرص .html" class="text-white text-decoration-none d-block">شارك معنا</a></li>
            <li class="mb-2"><a href="بنك الافكار.html" class="text-white text-decoration-none d-block">بنك الأفكار</a></li>
          </ul>
        </div>
        ...
        <div class="col-md-4 mb-4 order-3 order-md-3">
          ...
          <form class="d-flex flex-column flex-sm-row gap-1 mt-3">
            <input type="email" class="form-control" placeholder="ادخل بريدك الإلكتروني"style="width: 200px;">
            <button class="btn" style="background-color: #02d3ac; color: white;">اشتركي</button>
          </form>
        </div>
      </div>
